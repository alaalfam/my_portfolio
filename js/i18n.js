...
const translations = {
  en: {
    ...
    proj1_name: "Limak Studio",
    proj1_desc: "Luxury furniture brand website with a modern design and a cinematic scroll‑driven experience for a seamless user journey.",
    proj1_link: "Open Website ↗",

    proj2_name: "Furniture Online Shop",
    proj2_desc: "Responsive furniture e‑commerce website with a modern design and seamless user experience.",
    proj2_link: "Open Website ↗",

    proj3_name: "Furniture Admin Panel Online Shop",
    proj3_desc: "Responsive furniture e‑commerce admin panel website with a modern design and seamless user experience.",
    proj3_link: "Open Website ↗",

    proj4_name: "Asanbar Drivers",
    proj4_desc: "On‑demand freight platform connecting cargo firms with nearby truck drivers. Owned stabilization and core feature development, serving 50,000+ active users.",
    proj4_link: "Cafe Bazaar ↗",

    proj5_name: "Asanbar Broker",
    proj5_desc: "The broker‑side companion to Asanbar. Lets logistics brokers post loads, track shipments in real time and receive offers directly from carriers.",
    proj5_link: "Cafe Bazaar ↗",

    proj6_name: "TeaLink — Persian Hub",
    proj6_desc: "Community hub for the Persian diaspora, shipped as technical lead at Fluxodio with real‑time chat, notifications, and event registration.",
    proj6_link_play: "Google Play ↗",
    proj6_link_appstore: "App Store ↗",

    proj7_name: "Gerdoo",
    proj7_desc: "Production application built as technical lead at Fluxodio, owning architecture across mobile, backend and web layers.",
    proj7_link: "Cafe Bazaar ↗",

    proj8_name: "Startamin",
    proj8_desc: "Iran's first crowdfunding marketplace app — developed and launched end‑to‑end at Aaicco, from concept to store release in 6 months.",
    proj8_link: "Cafe Bazaar ↗",
  ...
  fa: {
    ...
    proj1_name: "لیمک استودیو",
    proj1_desc: "وب‌سایت برند لوکس مبلمان با طراحی مدرن و تجربه اسکرول سینمایی برای یک تجربه کاربری روان.",
    proj1_link: "مشاهده وب‌سایت ↗",

    proj2_name: "فروشگاه اینترنتی مبلمان",
    proj2_desc: "وب‌سایت فروشگاهی مبلمان با طراحی مدرن، ریسپانسیو و تجربه کاربری روان.",
    proj2_link: "مشاهده وب‌سایت ↗",

    proj3_name: "پنل مدیریت فروشگاه اینترنتی مبلمان",
    proj3_desc: "پنل مدیریت فروشگاه اینترنتی مبلمان با طراحی مدرن، ریسپانسیو و تجربه کاربری روان.",
    proj3_link: "مشاهده وب‌سایت ↗",

    proj4_name: "آسان‌بار رانندگان",
    proj4_desc: "پلتفرم حمل‌ونقل بار که شرکت‌های باربری را به رانندگان کامیون نزدیک متصل می‌کند. مسئول پایدارسازی و توسعه ویژگی‌های اصلی برای بیش از ۵۰ هزار کاربر فعال.",
    proj4_link: "کافه‌بازار ↗",

    proj5_name: "آسان‌بار بروکر",
    proj5_desc: "اپلیکیشن مکمل سمت واسطه‌های باربری در آسان‌بار. به بروکرها امکان ثبت بار، رهگیری لحظه‌ای محموله و دریافت پیشنهاد مستقیم از رانندگان را می‌دهد.",
    proj5_link: "کافه‌بازار ↗",

    proj6_name: "تی‌لینک — هاب فارسی‌زبانان",
    proj6_desc: "هاب اجتماعی برای فارسی‌زبانان مقیم خارج، به‌عنوان لید فنی در فلوکسودیو با چت لحظه‌ای، اعلان‌ها و ثبت‌نام رویداد توسعه داده شده است.",
    proj6_link_play: "گوگل‌پلی ↗",
    proj6_link_appstore: "اپ‌استور ↗",

    proj7_name: "گردو",
    proj7_desc: "اپلیکیشن تولیدی که به‌عنوان لید فنی در فلوکسودیو ساخته شده و مسئولیت معماری در لایه‌های موبایل، بک‌اند و وب را برعهده داشتم.",
    proj7_link: "کافه‌بازار ↗",

    proj8_name: "استارتامین",
    proj8_desc: "اولین اپلیکیشن بازار تأمین مالی جمعی ایران — توسعه و انتشار سرتاسری در آی‌کو، از ایده تا انتشار در فروشگاه‌ها ظرف ۶ ماه.",
    proj8_link: "کافه‌بازار ↗",
